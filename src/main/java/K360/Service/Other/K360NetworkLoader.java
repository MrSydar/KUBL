...
import K360.Service.Hash.Hasher;
...
public class K360NetworkLoader {
    ...
    public String post(String destUrl, String jsonObject) throws IOException {
        ...
        } else return dirtyResponseBody.substring(1, dirtyResponseBody.length() - 1).replace("\\", "");    //TODO: K360 returns responce body with extra characters, why ?
    }
